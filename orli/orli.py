...
class OrliModel(nn.Module, SegmentationBaseModel):
    ...
    def __init__(self, **kwargs):
        ...
        # ------------------------------------------------------------------
        # Encoder — timm features_only for all variants including RegNetX-8GF
        # (timm name: regnetx_080.tv2_in1k — same weights as torchvision
        # RegNet_X_8GF_Weights.IMAGENET1K_V2, 82.7% top-1 on ImageNet)
        # ------------------------------------------------------------------
